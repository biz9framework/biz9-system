...
import AdminProductList from './src/AdminProductList/AdminProductList';
import AdminProductEdit from './src/AdminProductEdit/AdminProductEdit';
import AdminOptionList from './src/AdminOptionList/AdminOptionList';
import AdminOptionEdit from './src/AdminOptionEdit/AdminOptionEdit';
...
export default function App({ navigation }) {
  return (
    <NavigationContainer independent ref={(ref) => setTopLevelNavigation(ref)}>
      ...
      <stack.Screen name="AdminOptionEdit" component={AdminOptionEdit} options={{ headerShown: false, tabBarStyle: { display: 'none' } }}></stack.Screen>
      <stack.Screen name="AdminOptionList" component={AdminOptionList} options={{ headerShown: false, tabBarStyle: { display: 'none' } }}></stack.Screen>
      <stack.Screen name="AdminProductList" component={AdminProductList} options={{ headerShown: false, tabBarStyle: { display: 'none' } }}></stack.Screen>
      <stack.Screen name="AdminProductEdit" component={AdminProductEdit} options={{ headerShown: false, tabBarStyle: { display: 'none' } }}></stack.Screen>
