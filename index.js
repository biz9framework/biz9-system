...
module.exports.framework_git_main_merge_checkout = function () {
    let commit_note='';
    let current_branch='';
    let confirm=false;
    async.series([
        ...
        function(call){
            ...
            if(confirm){
                //exec("git pull  --allow-unrelated-histories "+biz9_config.REPO+" main", (error, stdout, stderr) => {
                exec("git pull  "+biz9_config.REPO+" main", (error, stdout, stderr) => {
                    if (error) {
                        console.log(error);
                        call();
                    }else{
        ...
        function(call){
            ...
            if(confirm){
                ...
                //exec("git merge "+biz9_config.BRANCH,(error, stdout, stderr) => { if (error) {
                        console.log(error);
                        return;
                    }
                    console.log(stdout);
...
module.exports.framework_git_main_commit_push = function () {
    let commit_note='';
    let current_branch='';
    let confirm=false;
    async.series([
        function(call){
            Print.show_header('BiZ9 Framework Git Main Commit Push');
            call();
        },
        function(call){
            Print.show_git_info();
        ...
        function(call){
            ...
            if(confirm){
                exec("git push --set-upstream "+biz9_config.REPO+" main",(error, stdout, stderr) => {
                    if (error) {
                        console.log(error);
                        return;
                    }
        ...
        */
        function(call){
            console.log('1090000000000000000000');
            if(confirm){
                exec("git push -f "+biz9_config.REPO+" main",(error, stdout, stderr) => {
                    if (error) {
                        console.log(error);
                        return;
                    }
